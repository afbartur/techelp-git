...
$comando_sql = "UPDATE cadcurso SET nome = '$nome', modificadopor = '$modificadopor',
...
<br><br>
	...
	//header("location:index.html?link=2");
	  ...
	  ?>
		 ...
		 <a  class="form-signin" href="index.php?link=24"><input class="btn btn-lg btn-primary  margin40" type = "button" value="Voltar" /></a>
