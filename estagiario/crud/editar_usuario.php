...
onkeypress="javascript: mascara(this, cpf_mask);"  maxlength="14" />
  ...
  <div class="form-group col-md-4 ">
	...
	<input disabled type="text" class="form-control" value= "<?php echo $resultado['tipousuario'] ;?>" name="tipousuario">
	<input type="hidden" class="form-control" value= "<?php echo $resultado['tipousuario'] ;?>" name="tipousuario">
