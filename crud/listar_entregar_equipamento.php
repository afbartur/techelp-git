...
?>     
	...
	while($linhas= mysqli_fetch_array($resultado)){
		...
		<a href='index.php?link=60&id=<?php echo $linhas['id']; ?>'><button title="Editar" type='buton' class='btn butaox btn-primary '><i class="fa fa-pencil-square-o"></i> Edirar</button></a>
