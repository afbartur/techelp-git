...
$comando_sql = "UPDATE cadendregas SET nome = '$nome',nomeprofessor = '$nomeprofessor', equipamento = '$equipamento',situacao = '$situacao',dataentrega = '$dataentrega',dataprevista = '$dataprevista',datarecebido = '$datarecebido', local = '$local',sala = '$sala', horario1 = '$horario1',horario2 = '$horario2',horario3 = '$horario3',turno = '$turno',
