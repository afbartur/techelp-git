...
(nome,nomeprofessor,equipamento,situacao,dataentrega,dataprevista,datarecebido,local,sala,horario1,horario2,horario3,turno,criado) VALUES
('$nome','$nomeprofessor','$equipamento','$situacao','$dataentrega','$dataprevista','$datarecebido','$local','$sala','$horario1','$horario2','$horario3','$turno',NOW())";
